...
$id = $_SESSION['id'];
$sql = "select * from job_post natural join user_reg where worker_id = '$id' and status_flag = '-1'";
...
<div class="feedback">
				<div class="col-md-6">
					...
					<div class="agileits">
						<label>User name: <?php echo $row['uname'];?></label>
					</div>
					<div class="agileits">
						<label>Start: <?php echo $row['start'];?></label>
					</div>
					
					<div class="agileits">
						<label>Description: <?php echo $row['overview'];?></label>
					</div>
				<form method = "post" action = "acceptpost.php">
				
				<div class="clearfix"></div>
				<div class="w3_submit">
					<input type="submit" value="Accept" name ="<?php echo $jid?>"/>
				</div>
				</form>
				<form method = "post" action = "rejectpost.php">
				
				<div class="clearfix"></div>
				<div class="w3_submit">
					<input type="submit" value="Reject" name ="<?php echo $jid?>"/>
				</div>
				</form>
		</div>
	</div>
