...
<body style="background-color:gray;">
	...
	<h3><center>User Job Post</center></h3>
		<div class="column" style="background-color:white;">
			<form action="#" method="post">
				<div class="w3_modal_body_grid">
					<span>Category:</span>
					<select id="w3_country" onchange="change_country(this.value)" class="category">
						<option value="null">Select</option>
					</select>
				</div>
				<div class="w3_modal_body_grid">
					<span>Sub Category:</span>
					<select id="w3_country" onchange="change_country(this.value)" class="subcategory">
						<option value="null">Select</option>
					</select>
				</div>
			...
			<form action="#" method="post">
				<div class="fulltime" style="background-color:white;">
						<div class="w3_modal_body_grid w3_modal_body_grid1">
							...
							<input class="date" id="datepicker" name="start_time" type="text" value="mm/dd/yyyy"  onblur="if (this.value == '') {this.value = '2/08/2013';}" required="" />
						</div>
						<div class="w3_modal_body_grid w3_modal_body_grid1">
							<span>End Time:</span>
							<input class="date" id="datepicker" name="end_time" type="text" value="mm/dd/yyyy"  onblur="if (this.value == '') {this.value = '2/08/2013';}" required="" />
						</div>
				</div>
